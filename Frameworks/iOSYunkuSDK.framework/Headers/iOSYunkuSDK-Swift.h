...
+ (NSString * _Nonnull)getLocalStringFromBundle:(NSString * _Nonnull)key comment:(NSString * _Nonnull)comment SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)registerHook:(id <HookDelegate> _Nullable)delegate;
- (void)unRegisterHook;
@end
...
- (void)onGetFileUrl:(NSString * _Nonnull)url;
- (void)onFail;
@end
...
@protocol HookDelegate
- (BOOL)hookInvoke:(enum HookType)type fullPath:(NSString * _Nonnull)fullPath SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, copy) NSString * _Nonnull thumbBig;
@property (nonatomic, copy) NSString * _Nonnull fileHash;
@property (nonatomic, copy) NSString * _Nonnull thumbNail;
@property (nonatomic) uint64_t fileSize;
@property (nonatomic, readonly, copy) NSString * _Nonnull thumbBigCachePath;
@property (nonatomic, readonly, copy) NSString * _Nonnull localPath;
@property (nonatomic, readonly) uint64_t localFileSize;
@property (nonatomic, readonly) uint64_t thumbBigCacheSize;
@property (nonatomic, readonly, copy) NSString * _Nonnull thumbNailCachePath;
- (void)getFileUri:(void (^ _Nonnull)(BOOL, NSString * _Nonnull))resopnse;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end


@interface NSArray (SWIFT_EXTENSION(iOSYunkuSDK))
@end
...
@interface NSNull (SWIFT_EXTENSION(iOSYunkuSDK))
@end


@interface NSString (SWIFT_EXTENSION(iOSYunkuSDK))
@end
...
+ (NSString * _Nonnull)getLocalString:(NSString * _Nonnull)key comment:(NSString * _Nonnull)comment SWIFT_WARN_UNUSED_RESULT;
+ (UIImage * _Nonnull)getLocalImage:(NSString * _Nonnull)imageName SWIFT_WARN_UNUSED_RESULT;
+ (void)makeToast:(NSString * _Nonnull)message view:(UIView * _Nonnull)view;
+ (void)showProgress:(UIViewController * _Nonnull)control;
+ (void)hideProgress:(UIViewController * _Nonnull)control;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11iOSYunkuSDK13OnAckCallback")
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) enum SDKLogLevel logLevel;)
+ (enum SDKLogLevel)logLevel SWIFT_WARN_UNUSED_RESULT;
+ (void)setLogLevel:(enum SDKLogLevel)newValue;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull orgClientId;)
+ (NSString * _Nonnull)orgClientId SWIFT_WARN_UNUSED_RESULT;
+ (void)setOrgClientId:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull orgClientSecret;)
+ (NSString * _Nonnull)orgClientSecret SWIFT_WARN_UNUSED_RESULT;
+ (void)setOrgClientSecret:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull orgRootPath;)
+ (NSString * _Nonnull)orgRootPath SWIFT_WARN_UNUSED_RESULT;
+ (void)setOrgRootPath:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull orgRootTitle;)
+ (NSString * _Nonnull)orgRootTitle SWIFT_WARN_UNUSED_RESULT;
+ (void)setOrgRootTitle:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull orgOptName;)
+ (NSString * _Nonnull)orgOptName SWIFT_WARN_UNUSED_RESULT;
+ (void)setOrgOptName:(NSString * _Nonnull)value;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC11iOSYunkuSDK7SSLCert")
...
///
/// \endcode
SWIFT_CLASS("_TtC11iOSYunkuSDK19SocketClientManager")
...
@interface SocketEngine (SWIFT_EXTENSION(iOSYunkuSDK))
...
- (BOOL)hnk_shouldCancelImageForKey:(NSString * _Nonnull)key SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)hnk_shouldCancelBackgroundImageForKey:(NSString * _Nonnull)key SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface UIImage (SWIFT_EXTENSION(iOSYunkuSDK))
+ (UIImage * _Nullable)convertFromData:(NSData * _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
- (NSData * _Null_unspecified)asData SWIFT_WARN_UNUSED_RESULT;
@end
...
- (BOOL)hnk_shouldCancelForKey:(NSString * _Nonnull)key SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface YKMainViewController : UIViewController <UITableViewDataSource, UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIAlertViewDelegate, UIScrollViewDelegate, UITableViewDelegate>
@property (nonatomic, strong) Option * _Null_unspecified option;
@property (nonatomic, strong) id <HookDelegate> _Null_unspecified delegate;
- (void)viewDidLoad;
...
- (void)actionSheet:(UIActionSheet * _Nonnull)actionSheet didDismissWithButtonIndex:(NSInteger)buttonIndex;
